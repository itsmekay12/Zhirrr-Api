...
loghandler = {
    notparam: {
        ...
        getApikey: 'gak punya apikey? chat gw aja yaaa di wa.me/6283806733358'
    },
    notkey: {
        status: false,
        creator: `${creator}`,
    ...
    invalidKey: {
        ...
        creator: `${creator}`,
        code: 406,
        message: 'apikey invalid, apikey ada di home sayang:)'
    },
    invalidlink: {
        status: false,
        creator: `${creator}`,
...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'kawaiapi') return res.json(loghandler.invalidKey)
...
router.get('/cekapikey', async(req, res, next) => {
  ...
  if(!apikey) return res.json(loghandler.notparam)
  if(apikeyInput != 'kawaiapi, kaylacancik') return res.json(loghandler.invalidKey)
    res.json({
      status: 'active',
      creator: `${creator}`,
      apikey: `${apikey}`,
